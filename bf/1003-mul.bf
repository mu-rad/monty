...
# Result must be less than 10 (a single digit number)
# given the example 42: 4 will be in block #1 2 will be in block #2
...
# loop while block 2 != 0 adding the value of block 1 to block 0 each time of the iteration
# BLOCK 0   BLOCK 1     BLOCK 2     BLOCK 3     BLOCK4
# 0     4       1       0     
>,------------------------------------------------ # read into #1
>,------------------------------------------------ # read into #2
[<[>>+<<<+>-]>>[<<+>>-] COPY BLOCK 1 INTO BLOCK 3 AND 0 AFTER THAT COPY BLOCK 3 BACK TO BLOCK 1
<-] MOVE BLOCK TO BLOCK 2 AND PERFORM AN DECREAMENT (DONE WITH ONE ITERATION)
# MOVE TO BLOCK 0 AND PERFORM AN INCREAMENT BY ASCII '0' (DEC 48)
<<++++++++++++++++++++++++++++++++++++++++++++++++.
